## Module for checking memory limitations and whether given values for 'generate' will cause a memory error. 
import os
import sys

# Values for arbitrary limits for generators throughout package. 
